        ...
        public IActionResult Customize(Product product, int shapeid)
        {
            ...
            if (member == null)
            {
                ...
                if (cartVm == null)
                {
                    ...
                    cartVm.Shape = shapeid == 1 ? "Düzbucaq" : (shapeid == 2 ? "Kvadrat" : (shapeid == 3 ? "Oval" : (shapeid == 4 ? "Yumru" : (shapeid == 6 ? "Paxlava" : (shapeid == 7 ? "Petek" : (shapeid == 8 ? "Duymeli Petek" : (shapeid == 9 ? "Ellips" : (shapeid == 10 ? "Kerpic" : (shapeid == 11 ? "Horumcek Toru" : (shapeid == 12 ? "Gunew" : "Razbijka"))))))))));
                    ...
                    cartVm.Diametr = product.Diametr == null ? 0 : product.Diametr; 
                    products.Add(cartVm);
            ...
            else
            {
                ...
                cartItem = new CartItem
                {
                    ...
                    Shape = shapeid == 1 ? "Düzbucaq" : (shapeid == 2 ? "Kvadrat" : (shapeid == 3 ? "Oval" : (shapeid == 4 ? "Yumru" : (shapeid == 6 ? "Paxlava" : (shapeid == 7 ? "Petek" : (shapeid == 8 ? "Duymeli Petek" : (shapeid == 9 ? "Ellips" : (shapeid == 10 ? "Kerpic" : (shapeid == 11 ? "Horumcek Toru" : (shapeid == 12 ? "Gunew" : "Razbijka")))))))))),
                    ...
                    IsAccessory = false,
                    Diametr = product.Diametr == null ? 0 : product.Diametr,
                    Count = 1
